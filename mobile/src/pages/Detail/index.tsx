...
const Detail = () => {
    ...
    return (
        <SafeAreaView style={{ flex: 1 }}>
            ...
            <Image style={styles.pointImage} source={{ uri: 'https://images.unsplash.com/photo-1556767576-5ec41e3239ea?ixlib=rb-1.2.1&ixid=eyJhcHBfaWQiOjEyMDd9&auto=format&fit=crop&w=400&q=50'}}/>
            ...
            <View style={styles.address}> 
                ...
                <Text style={styles.addressContent}>Joinville, SC.</Text>
            </View>
            </View>
